...
(function () {
	...
	// CSS Styles
	$head.append('<link rel="stylesheet" href="Content/style-switcher.css">');
	...
	var $styleHTML = '<div id="style-switcher">';
			...
			$styleHTML += '<li class="active"><a href="#" data-color-code="2aadde" data-path="Content/Style.css"></a></li>';
				$styleHTML += '<li><a href="#" data-color-code="99B709" data-path="Content/color/green.css"></a></li>';
				$styleHTML += '<li><a href="#" data-color-code="F43A3B" data-path="Content/color/red.css"></a></li>';
				$styleHTML += '<li><a href="#" data-color-code="F6A70E" data-path="Content/color/orange.css"></a></li>';
				$styleHTML += '<li><a href="#" data-color-code="904799" data-path="Content/color/violet.css"></a></li>';
			$styleHTML += '</ul>';
		$styleHTML += '</div>';
...
// Candidates Views
// ---------------------------------------------------------
$('.candidates-view-toggle').each(function () {
    var $this = $(this),
		$items = $this.closest('.page-content').find('.candidates-item');
